...
if("TRUE" STREQUAL "TRUE")
  set(i2cpwm_board_SOURCE_PREFIX /home/pi/catkin_ws/src/i2c_pwm_board)
...
if(NOT "/home/pi/catkin_ws/devel/include;/home/pi/catkin_ws/src/i2c_pwm_board/include " STREQUAL " ")
  set(i2cpwm_board_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/catkin_ws/devel/include;/home/pi/catkin_ws/src/i2c_pwm_board/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT "brandanlane.gitlab.io/ros-i2cpwmboard " STREQUAL " ")
    set(_report "Check the website 'brandanlane.gitlab.io/ros-i2cpwmboard' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'bradanlane <locoro@bradanlane.com>, Emiliano Borghi <emiliano.borghi@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'i2cpwm_board' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/catkin_ws/src/i2c_pwm_board/${idir}'.  ${_report}")
    endif()
    _list_append_unique(i2cpwm_board_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "i2cpwm_board")
